...
"""autogenerated by genpy from demo_action/AddIntsActionResult.msg. Do not edit."""
import codecs
import sys
...
class AddIntsActionResult(genpy.Message):
  ...
  _type = "demo_action/AddIntsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','demo_action/AddIntsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = demo_action.msg.AddIntsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = demo_action.msg.AddIntsResult()
